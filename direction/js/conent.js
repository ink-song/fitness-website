...
var smallLeft = document.getElementById("small-left");  //左边的小盒子

var smallBox = document.getElementById("small-box")   //点击的小盒子
*/


/*
smallBox.onclick = function(){
    smallLeft.style.opacity = 0;
    animate(box,{"right":-210})
